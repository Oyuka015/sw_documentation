...
## 1. Ерөнхий тойм
Энэхүү баримт бичигт GPT-4 загвараар AppFlowy төсөлд зориулан үүсгүүлсэн SRS заалтуудыг багийн гишүүдийн боловсруулсан SRS-тэй харьцуулж, AI-ийн гаргасан зөрүү болон алдааг (Discrepancies) хэрхэн засаж сайжруулсныг аудитын лог хэлбэрээр баримтжуулав.
...
| **3** | **Тестийн процедур ба UI мок-ап хаягдсан** *(Missing Verification & Artifacts)* | *"FR-05: Users can drag and drop cards in Kanban view to change their status."* | *"FR-05: The system shall update a task card's status field immediately when the user drags the card into a different Kanban column."* | AI нь зөвхөн хэрэглэгчийн хүслийг товч бичээд шалгах процедур болон шалгуур үзүүлэлтийг хаясан. Bhatti Ch. 5 (p. 96) "Use-Verify-Cite" зарчмаар тестийн алхмуудыг гүйцээв. |

---

## 3. Дүгнэлт
AI нь шаардлагын анхны нооргийг хурдан гаргахад тустай ч хэмжигдэхүйц нарийн хязгаар (Measurable boundaries), шалгах тест процедур болон баримт бичгийн бүтцийн стандартыг баримтлахдаа алдаа гаргаж байна. Хүний оролцоотойгоор AI-ийн гаргасан тодорхойгүй заалтуудыг засаж, шалгаж болохуйц шаардлага болгон засав.