...
* **Шалгах дараалал:**
  ...
  3. Ямар нэгэн товчлуурахгүйгээр 500ммс хүлээнэ.
...
* **Баталгаажуулах нөхцөл:** Програм đột ngột хаагдахад нэг ч тэмдэгт гээгдэхгүй.
...
* **Зэрэглэл:** `must`
* **Шалгах дараалал:**
  1. Эцэг хуудас А болон Хүү хуудас Б-г үүсгэнэ.
...
* **Баталгаажуулах нөхцөл:** Хуудасны бүтэц нүдэн дээр шинэчлэгдэж, эцэг-хүү хамаарал өгөгдлийн санд хадгалагдана.

### FR-03: Барагтай текстын блокон редактор (Rich-Text Block Editor)
...
* **Зэрэглэл:** `must`
* **Шалгах дараалал:**
  1. "Шүүмжилж байна" нэртэй шинэ багана нэмнэ.
...
### FR-05: Карт чирж төлөв өөрчлөх (Card Drag-and-Drop Reassignment)
...
* **Шалгах дараалал:**
  1. "Хийх" баганад Карт Х үүсгэнэ.
  2. Карт Х-г "Дууссан" багана руу чирж оруулна.
  3. Карт Х-ийн шинж чанарыг нээж, төлөвийн шошгыг шалгана.
* **Баталгаажуулах нөхцөл:** Картны төлөв автомат тохиргоогоор "Дууссан" болж өөрчлөгдөнө.

### FR-06: Хүснэгтэн харагдацын шүүлтүүр (Grid View Filtering)
...
* **Шалгах дараалал:**
  ...
  2. Экспортлох -> Markdown сонголтыг дарна.
  3. Үүссэн файлыг энгийн текст редактороор нээнэ.
* **Баталгаажуулах нөхцөл:** Экспортлогдсон файл стандарт Markdown форматыг (`#`, `##`, `*`) бүрэн агуулсан байна.

### FR-08: Дэлгэцийн сэдэв өөрчлөх (Dark and Light Theme Toggle)
* **Тодорхойлолт:** Систем нь програмыг дахин эхлүүлэх шаардлагагүйгээр UI өнгөний сонголтыг Гэгээн (Light), Харанхуй (Dark) болон Системийн горим хооронд шууд өөрчилнө.
* **Зэрэглэл:** `should`
* **Mock UI Screenshot:** `![Theme Toggle UI](./mockups/fr08-theme-toggle.png)`
* **Шалгах дараалал:**
  1. Тохиргоо -> Харагдац хэсэг рүү орно.
  2. Харанхуй горимыг сонгоно.
...
* **Тодорхойлолт:** Систем нь хэрэглэгчийн хүсэлтээр SQLite өгөгдлийн сан болон медиа файлуудыг агуулсан шахагдсан `.zip` архив файл үүсгэнэ.
* **Зэрэглэл:** `must`
* **Шалгах дараалал:**
  1. Тохиргоо -> Хадгалах санах ой -> Нөөц хуулбар экспортол сонголтыг сонгоно.
...
* **Шалгах дараалал:**
  ...
  2. Rust кодын түлхүүр үгс агуулсан (`fn`, `let`, `match`) фрагмент буулгана.
...
* **Шалгах дараалал:**
  ...
  2. Эрэмбэлэх -> Тоон багана -> Өсөх дараалал гэж сонгоно.
...
* **Тодорхойлолт:** Систем нь хэрэглэгчид локал зургийн файлуудыг (PNG, JPG, WebP) редактор дотор оруулж, локал медиа папк дотор хадгалах боломжийг олгоно.
* **Зэрэглэл:** `should`
* **Mock UI Screenshot:** `![Image Block UI](./mockups/fr14-image-block.png)`
* **Шалгах дараалал:**
  1. `/image` гэж бичээд `diagram.png` файлыг хуулж оруулна.
* **Баталгаажуулах нөхцөл:** Зураг редактор дотор харагдаж, локал медиа папк руу хуулагдана.

### FR-15: Шошго хувиарлан үүсгэх (Custom Property Tag Creation)
